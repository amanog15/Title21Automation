				...
				if(adminCreateGroup.groupFilterResult() != null)
				{
					...
					if(adminCreateGroup.verifyDeleteGroupPopUp()) 
					{
						...
						if(adminCreateGroup.groupFilterResult() != null)
						{
							...
							if(GroupPresenceAfterSearch) {
								test.log(LogStatus.FAIL, "Unable to delete existing group: "+groupData[1][1]+" "+
